...
const AboutEnergy = () => {
  return (
    <section className="bg-primary-500 pt-[76px] pb-[105px] md:pb-[141px] md:pt-[133px]">
      <div className="container mx-auto px-5 md:px-8 2xl:px-40">
        <div className="grid text-center md:grid-cols-2 md:text-left">
          <div className="max-w-[494px] text-3.3xl font-bold leading-[37px] text-neutral-0 md:text-5xl md:leading-[58px]">
            Energy’s role in advancing society
          </div>
          <div className="mt-6 max-w-[634px] text-base text-neutral-10 md:mt-0 md:text-4.5xl">
